...
function AddTask({bgColor,show}) {
    return (
        <div className="flex justify-center mb-4">
            <button className={`${bgColor=="bg-pomodoro"? "bg-darkRed": bgColor=="bg-pomoblue"? "bg-blueButton": "bg-darkBlueButton" } text-[#ffffff8a] w-[42vh] mt-6 border-2 border-dashed border-[#ffffff6a] py-5 rounded-md flex place-content-center font-bold `} onClick={()=>show()}> <FaPlusCircle className="mt-0.5 text-lg"/> <p className="ml-3">Add Task</p></button>
